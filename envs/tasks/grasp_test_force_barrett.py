...
class IsaacGraspTestForce_barrett(BaseTask):
    ...
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless,
        ...
        # 'bh_j31_joint', 'bh_j32_joint', 'bh_j33_joint']
    ...
    def _set_normal_force_pose(self):
        ...
        hand_model = get_handmodel('barrett', self.env_num, self.device, 1.)
    ...
    def _load_agent(self, env_ptr, env_id):
        ...
        if self.dexterous_loaded == False:
            ...
            dexterous_asset_file = "movable_hand_urdf/barrett/robots/movable_barrett.urdf"
    ...
    def q_transfer_o2s(self, opt_q):
        ...
        # todo: to finish
        sim_joint_angle[:, 0:3] = opt_joint_angle[:, 2:5]
        sim_joint_angle[:, 3:6] = opt_joint_angle[:, 5:8]
        sim_joint_angle[:, 6:8] = opt_joint_angle[:, 0:2]
    ...
    def get_q_as_opt(self):
        ...
        opt_q_angle[:, 0:2] = sim_q_angle[:, 6:8]
        opt_q_angle[:, 2:5] = sim_q_angle[:, 0:3]
        opt_q_angle[:, 5:8] = sim_q_angle[:, 3:6]
...
if __name__ == "__main__":
    ...
    init_opt_q = torch.zeros(16, 9+8, device='cuda')
    init_opt_q[:, 0] = 0.1
    ...
    env = IsaacGraspTestForce_barrett(cfg, sim_params, gymapi.SIM_PHYSX, "cuda", 0, False,
